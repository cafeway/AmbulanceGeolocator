...
class NavigationPage extends StatefulWidget {
  const NavigationPage({required this.title});
    ...
    if (!mounted) return;
        _directions = MapBoxNavigation(onRouteEvent: _onRouteEvent);
           _options = MapBoxOptions(
                     initialLatitude: -1.280423,
                     initialLongitude: 	36.816311,
                     zoom: 13.0,
                     tilt: 0.0,
                     bearing: 0.0,
                     enableRefresh: false,
                     ...
                     simulateRoute: true,
                     language: "en");            
    final cityhall = WayPoint(name: "City Hall", latitude: -1.28395, longitude: 36.818474);
    final downtown = WayPoint(name: "Downtown Buffalo", latitude: -1.286389, longitude:	36.817223);
